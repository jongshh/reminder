export const navItems = [
  { id: "home", label: "나의 루틴 방", shortLabel: "홈", icon: "Home" },
  { id: "characters", label: "캐릭터", shortLabel: "친구", icon: "UserRound" },
  { id: "quests", label: "오늘의 퀘스트", shortLabel: "퀘스트", icon: "ListChecks" },
  { id: "checkin", label: "체크인", shortLabel: "체크", icon: "CheckCircle2" },
  { id: "quest", label: "퀘스트 상세", shortLabel: "상세", icon: "ScrollText" },
  { id: "report", label: "주간 리포트", shortLabel: "주간", icon: "BarChart3" },
  { id: "profile", label: "성장 기록", shortLabel: "성장", icon: "Sparkles" },
  { id: "settings", label: "계정 설정", shortLabel: "설정", icon: "Settings" },
  { id: "onboarding", label: "시작 설정", shortLabel: "시작", icon: "Compass" },
];
...
export const userProfile = {
  ...
  badges: [
    ...
    { id: "recovery", label: "회복 준비", tone: "recovery" },
  ],
};
...
export const difficultySuggestion = {
  title: "오늘의 제안",
  message: "시간이 부족하면 메인 1개를 미니 루틴으로 줄여도 괜찮아요.",
...
export const todayQuests = [
  ...
  },
  {
    ...
    visual: "10",
    color: "violet",
    description: "컨디션이 낮은 날을 위한 짧은 대체 루틴입니다.",
